        ...
        <el-container>
            ...
            <el-main style="background-image: none; display: block; height: auto;">
                    ...
                    <div class="form-wrapper">
                        ...
                        <div class="search-area">
                            <el-form :inline="true" :model="form2" label-width="20%"
                                ...
                                <el-form-item label="员工姓名" prop="key" label-width="100px">
                ...
                <el-table :data="emps" style="width: 100%">
                    <el-table-column prop="emp_name" label="员工姓名" width="150" />
                    <el-table-column prop="emp_shop_id__shop_name" label="所属店铺名" />
                    <el-table-column prop="emp_role" label="角色" />
                    <el-table-column prop="emp_condition" label="员工状态" />
                    <el-table-column prop="emp_tel" label="员工联系电话" />
                    <el-table-column prop="emp_number" label="员工号" />
                ...
                <el-dialog style="margin-right: 58vh; margin-top: 25vh;" v-model="dialogVisible3" title="修改员工信息"
                    width="500">
                    <br>
                    <el-form ref="ruleFormRef3" :model="form3" :rules="rule" label-width="20%" class="demo-form"
                        ...
                        <el-form-item label="员工角色" prop="emp_role">
...
import { $signout, $getEmpData, $delEmp, $updateEmp } from '@/api/super';
import {
