        ...
        <el-container>
            ...
            <el-main style="background-image: none; display: block; height: auto;">
                    ...
                    <div class="form-wrapper">
                        ...
                        <div class="search-area">
                            <el-form :inline="true" :model="form2" label-width="20%"
                                ...
                                <el-form-item label="支付时间" prop="key" label-width="100px">
                                    <el-input v-model="form2.key" style="width: 350px;" clearable placeholder="例：2024-01-01" />
                                </el-form-item>
                                <el-form-item>
                ...
                <el-table :data="orders" style="width: 100%">
                    ...
                    <el-table-column prop="pay_num" label="支付号" />
                ...
                <el-dialog style="margin-right: 58vh; margin-top: 35vh;" v-model="dialogVisible3" title="修改支付记录"
                    width="500">
                    <br>
                    <el-form ref="ruleFormRef3" :model="form3" :rules="rule" label-width="17%" class="demo-form"
                        status-icon>
                        <el-form-item label="订单金额" prop="pay_money">
                            <el-input v-model="form3.pay_money" />
                        </el-form-item>

                        <el-form-item label="支付方式" prop="pay_way">
                            <el-input v-model="form3.pay_way" />
                        </el-form-item>
                    </el-form>
...
import { $signout, $getPayData, $delPay, $updatePay } from '@/api/super';
import {
...
function confirmEdit() {
    ...
    ruleFormRef3.value.validate((valid) => {
        if (valid) {
            let editedData = {
                pay_money: form3.pay_money,
                pay_way: form3.pay_way
            };
            const pay_id = rowToEdit.value.id;
            editNoti(pay_id, editedData);
...
const editNoti = (id, editedRow) => {
    $updatePay(id, editedRow)
        .then(function (data) {
            alert('修改成功')
            console.log(data);
            getData('', 1);
