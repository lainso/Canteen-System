        ...
        <el-container>
            ...
            <el-main style="background-image: none; display: block; height: auto;">
                ...
                <el-table :data="dishs" style="width: 100%">
                    ...
                    <el-table-column prop="dish_shop" label="所属店铺名" />
                ...
                <el-dialog style="margin-right: 58vh; margin-top: 25vh;" v-model="dialogVisible3" title="修改菜品信息"
                    width="500">
                    <br>
                    <el-form ref="ruleFormRef3" :model="form3" :rules="rule" label-width="17%" class="demo-form"
                        ...
                        <el-form-item label="描述" prop="dish_des">
...
import { $signout, $getDishData, $delDish, $updateDish } from '@/api/super';
import {
