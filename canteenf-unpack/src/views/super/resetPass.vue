<template>
    <div class="login">
        <img class="left" src="../../assets/img/super/super_resetDef_back.jpg" alt="left poster">
        <div class="box">
            ...
            <div style="display: flex; text-align: center;">
                ...
                <span class="regPart">
                    <el-link :underline="false" type="primary" href="#/super/login">返回登录</el-link>
                </span>
            </div>
...
import { $resetDefPass } from '@/api/super';
...
const onSubmit = (formEl) => {
    ...
    formEl.validate((valid) => {
        if (valid) {
            $resetDefPass(form.username)
                .then(function (data) {
                    alert("已重置为默认密码。默认密码可询问运维人员。")
                    console.log(data);
                })
