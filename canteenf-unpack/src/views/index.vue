        ...
        <el-container>
            ...
            <el-main>
                <div style="max-width: 700px; margin: auto;">
                    <br><br>
                    <p style="text-align: center; font-size: 24px;">尊敬的顾客 {{ userInfo.first_name }}，欢迎登录内部餐饮系统！</p>
                    <br><br>
                    <div class="block text-center" m="t-4">
                        <el-carousel trigger="click" height="300px" motion-blur="true">
                            <el-carousel-item>
                                <img class="banner" src="../../src/assets/img/main_banner1.jpg">
                            </el-carousel-item>
                            <el-carousel-item>
                                <img class="banner" src="../../src/assets/img/main_banner2.jpg">
                            </el-carousel-item>
                            <el-carousel-item>
                                <img class="banner" src="../../src/assets/img/main_banner3.jpg">
                            </el-carousel-item>
                            <el-carousel-item>
                                <img class="banner" src="../../src/assets/img/main_banner4.jpg">
                            </el-carousel-item>
                        </el-carousel>
                    </div><br><br>
...
import { $signout, $getMyInfo } from '@/api/customer';
