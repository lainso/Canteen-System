<template>
    <div class="login">
        <img class="left" src="../../assets/img/shop/shop_login_back.jpg" alt="left poster">
        <div class="box">
            ...
            <el-form ref="ruleFormRef" :model="form" :rules="rules" label-width="20%" class="demo-form" status-icon>
                ...
                <el-form-item style="margin-bottom: 1%;">
                    <el-link style="margin-left: 82%;" :underline="false" type="danger" @click="resetPass">忘记密码</el-link>
                </el-form-item>
                <el-form-item>
...
const resetPass = () => {
    alert('商户端不允许未登录自行重置密码，若忘记密码请联系系统管理员。')
}
