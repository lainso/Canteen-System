    ...
    <el-container style="height: 100vh;">
        ...
        <el-header class="header-menu">
            <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" :ellipsis="false">
                ...
                <el-menu-item @click="GoIndex" index="1" style="font-weight: bold; margin-left: 3rem;"> 内 部 餐 饮 系 统 - 商 户 端
                </el-menu-item>
                <div class="flex-grow" />
        ...
        <el-container>
            ...
            <el-main>
                <div style="max-width: 700px; margin: auto;">
                    <br><br>
                    <p style="text-align: center; font-size: 24px;">商户 {{ userInfo.first_name }}，欢迎登录内部餐饮系统！</p>
                    <br><br>
                    <div class="block text-center" m="t-4">
                        <el-carousel trigger="click" height="300px" motion-blur="true">
                            <el-carousel-item>
                                <img class="banner" src="../../assets/img/shop/main_banner1.jpg">
                            </el-carousel-item>
                            <el-carousel-item>
                                <img class="banner" src="../../assets/img/shop/main_banner2.jpg">
                            </el-carousel-item>
                            <el-carousel-item>
                                <img class="banner" src="../../assets/img/shop/main_banner3.jpg">
                            </el-carousel-item>
                            <el-carousel-item>
                                <img class="banner" src="../../assets/img/shop/main_banner4.jpg">
                            </el-carousel-item>
                        </el-carousel>
                    </div><br><br>
...
import { $signout, $getMyInfo } from '@/api/shop';
